...
int main(int argc, char* argv[])
{
	...
	printf("Featurepool initialize success.\n");	
	if (b_display) init_track_display(disp_scale);
	printf("Display initialize success.\n");
	//
	// Main loop
	//
	...
	while(b_run)
	{
		...
		if (b_display) {
			...
			printf("Entered b_display branch.\n");
		}
		...
		printf("Playback success with ctime:%d\n", ctime);
		if (ctime < 0) break;
		...
		printf("Predict camera rotation from IMU success.\n");
		//
		...
		printf("Track and select features success.\n");
		//
		// Step 4: Display
		//
